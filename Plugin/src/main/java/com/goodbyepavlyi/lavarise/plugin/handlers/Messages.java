...
public class Messages extends ConfigUtil {
    public Messages(LavaRise instance, String path, boolean save) {
    ...
    public String COMMAND_ARENA_SET_LOBBY_SUCCESS(String worldName, int blockX, int blockY, int blockZ) {
        return this.getString("command.arena.set.lobby.success")
                .replaceAll("%worldName%", worldName)
                .replaceAll("%blockX%", String.valueOf(blockX))
                .replaceAll("%blockY%", String.valueOf(blockY))
                .replaceAll("%blockZ%", String.valueOf(blockZ));
    }

    public String COMMAND_ARENA_SET_GAMEAREA_SUCCESS(ArenaOptions.GameArea gameArea, String worldName, int blockX, int blockY, int blockZ) {
